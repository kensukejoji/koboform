...
・VRゴーグル PICO G3（専用アプリセット込み）: 1台 130千円（¥129,800税込・定価）※大量購入割引あり
・JollyGood+プラットフォーム年間利用料（ゴーグル台数に応じてプラン選択）:
...
・VRコンテンツ: テーマに応じて3〜8本、ゴーグルは20〜80台を目安（台数 × 130千円で計上）
・プラットフォーム利用料はゴーグル台数に合ったプランの年間料金で計上すること
...
出力するJSONの構造:
{
  ...
  "keihi": {
    "kb1": { "hojo": 3900, "futan": 0, "naiyou": "VRゴーグル PICO G3（専用アプリセット）30台 × 130千円" },
    "kb2": { "hojo": 300, "futan": 0, "naiyou": "消耗品費（記録媒体・周辺機器等）" },
    "kb3": { "hojo": 5000, "futan": 2000, "naiyou": "プロジェクト研究員・URA人件費" },
    "kb4": { "hojo": 1200, "futan": 700, "naiyou": "外部専門家・委員会委員謝金" },
    "kb5": { "hojo": 600, "futan": 300, "naiyou": "国内旅費（委員会・視察・普及活動）" },
    "kb6": { "hojo": 12000, "futan": 0, "naiyou": "VRコンテンツ制作委託費（株式会社ジョリーグッド）4本" },
    "kb7": { "hojo": 200, "futan": 0, "naiyou": "成果報告書・パンフレット印刷費" },
    "kb8": { "hojo": 100, "futan": 0, "naiyou": "通信・運搬費" },
    "kb9": { "hojo": 3700, "futan": 0, "naiyou": "JollyGood+プロフェッショナルプラン年間利用料2,640千円＋VR導入研修・カリキュラム設計費1,060千円（株式会社ジョリーグッド）" }
  }
}
EOT;
...
・VRコンテンツ: テーマに応じて2〜5本、ゴーグルは10〜40台を目安（台数 × 130千円で計上）
・プラットフォーム利用料はゴーグル台数に合ったプランの年間料金で計上すること
...
出力するJSONの構造:
{
  ...
  "keihi": {
    ...
    "kb6": { "hojo": 25000, "futan": 0, "naiyou": "VRコンテンツ制作委託費（株式会社ジョリーグッド）・カリキュラム設計・コンサルティング一式" },
    "kb7": { "hojo": 200, "futan": 0, "naiyou": "成果報告書・プログラム案内印刷費" },
    "kb8": { "hojo": 100, "futan": 0, "naiyou": "通信・運搬費" },
    "kb9": { "hojo": 3100, "futan": 0, "naiyou": "JollyGood+プロフェッショナルプラン年間利用料2,640千円＋VR導入研修・デジタルバッジ発行費460千円（株式会社ジョリーグッド）" }
  }
}
EOT;
